...
export default function BlogPost({ siteTitle = "poladuco", frontmatter, markdownBody }) {
  ...
  return (
    <Layout pageTitle={`${siteTitle} | ${frontmatter.title}`}>
      <Link href="/">
        <a className="group flex flex-row justify-start mx-4 md:mx-6 lg:mx-8 my-4 outline-none">
      ...
      <article>
        ...
        <div className="items-center text-frontSecondary flex flex-row justify-center mb-4">
          <IconCalendar size={14} className="fill-current text-frontSecondary mr-1" />
          <h2 className="text-sm text-frontSecondarymr-1">Published on</h2>
          <h2 className="italic text-sm text-frontSecondary">{frontmatter.date}</h2>
        </div>
        <div className="prose mx-6 md:mx-8 lg:mx-12 max-w-none my-10">
